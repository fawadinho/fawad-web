...
@Component({
  selector: 'app-supplier-order-products',
  templateUrl: './supplier-order-products.component.html',
})
export class SupplierOrderProductsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SupplierOrderProductsComponent>,
